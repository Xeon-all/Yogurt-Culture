...
namespace YogurtCulture.GameLoop
{
    ...
    public class GameLoopManager : Singleton<GameLoopManager>
    {
        ...
        private PhaseHandlerBase _currentHandler;
        ...
        {
            _eventBus.Publish(new OnTransitionPhase{
        ...
        private void EnterPhase(GamePhase phase)
        {
            ...
            _currentHandler = Activator.CreateInstance(handlerType, new object[] { Instance }) as PhaseHandlerBase;
    ...
    public struct OnTransitionPhase
    {
